package ru.dz.shipMaster.dev.display;
...
import ru.dz.shipMaster.data.com.ComPortGnuIO;
import ru.dz.shipMaster.data.misc.CommunicationsException;
import ru.dz.shipMaster.dev.DriverPort;
import ru.dz.shipMaster.dev.ThreadedDriver;

public class SigmaASC105 extends ThreadedDriver {
	
	private ComPortGnuIO comPort;
	//private boolean isRed; // TO DO kill state - use different driver inputs for diff colors
	...
	public static void main(String[] args) throws CommunicationsException {
		SigmaASC105 driver = new SigmaASC105();
	...
	private void doSendText(String text) throws CommunicationsException
	{
		// \a - dark red
		// \b - red
		// \d - light yellow
	...
	private void sendString(String text) throws CommunicationsException {
	...
	private void sendByte( int b ) throws CommunicationsException
	{
		byte [] buf = new byte[1]; 
	...
	protected void setupPanel(JPanel panel) {
		panel.add(new JLabel("Port:"), consL);
		panel.add(portNameField = new JTextField(portName), consR);
		portNameField.setColumns(20);
	...
	@Override
	public String getInstanceName() {		return portName;	}
	...
	public void doLoadPanelSettings() {
		portNameField.setText(getPortName());
	}

	@Override
	public void savePanelSettings() {
		try {
			setPortName(portNameField.getText());
	...
	protected void doStartDriver() throws CommunicationsException {
		comPort = new ComPortGnuIO(portName, 9600);
		sendText(startupText);
	}

	@Override
	protected void doStopDriver() {
		while(!queue.isEmpty())
			sleep(100);
	...
	public void setPortName(String portName) throws CommunicationsException {	this.portName = portName;	}
