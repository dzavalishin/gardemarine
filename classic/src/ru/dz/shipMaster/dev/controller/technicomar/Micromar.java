package ru.dz.shipMaster.dev.controller.technicomar;
...
public class Micromar extends BusBasedDriver<ModBus> {
	...
	protected void setRegister(int holding_reg_no, int value) {
		try {
			...
			bus.presetSingleRegister( unitBase, holding_reg_no, value );
	...
	protected void doDriverTask() throws Throwable {
		...
		try {
			bus.readInputRegisters(unitBase, 0, INPUT_HOLDING_REGISTERS, readBuffer );
