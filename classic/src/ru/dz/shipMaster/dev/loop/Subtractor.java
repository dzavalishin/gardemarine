...
public class Subtractor extends AbstractDriver {
	...
	@Override
	public String getDeviceName() { return "Subtractor"; }
	...
	protected void updatePorts(Vector<DriverPort> ports) {
		...
		resultPort = getPort(ports, 2, Direction.Input, Type.Numeric, "Difference");
	}
