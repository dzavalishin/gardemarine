...
public class ConfigTree<ItemType extends IConfigListItem> extends GeneralItemTree<ItemType> implements Serializable {
	/**
	 * 
	 */
	...
	public ConfigTree(Class<ItemType> myc, final Vector<ItemType> items, final Vector<ItemType> libItems )
	{
